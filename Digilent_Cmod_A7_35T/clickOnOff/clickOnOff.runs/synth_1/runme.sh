...
HD_PWD='C:/Users/photquant/VivadoProjects/Digilent_Cmod_A7_35T/clickOnOff/clickOnOff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clickOnOff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clickOnOff.tcl
