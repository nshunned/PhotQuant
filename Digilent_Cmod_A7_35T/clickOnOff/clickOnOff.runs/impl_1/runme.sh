...
HD_PWD='C:/Users/photquant/VivadoProjects/Digilent_Cmod_A7_35T/clickOnOff/clickOnOff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clickOnOff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clickOnOff.tcl -notrace
