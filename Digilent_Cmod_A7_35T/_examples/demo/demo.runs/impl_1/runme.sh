...
HD_PWD='C:/Users/photquant/VivadoProjects/Digilent_Cmod_A7_35T/demo/demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CmodA735T_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CmodA735T_Demo.tcl -notrace
