...
--               /home/ciprian/Documents/Github/Cmod-A7/hw/proj/hw.srcs/sources_1/bd/user_35t/ip/user_35t_axi_emc_0_0/user_35t_axi_emc_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of user_35t_axi_emc_0_0_mem_state_machine is
  ...
  signal \mem_oen_reg[0]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \READ_COMPLETE_PIPE_GEN[0].READ_COMPLETE_PIPE_i_2\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \READ_COMPLETE_PIPE_GEN[0].READ_COMPLETE_PIPE_i_3\ : label is "soft_lutpair74";
  ...
  attribute SOFT_HLUTNM of \mem_oen_reg[0]_i_4\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \mem_oen_reg[0]_i_5\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \mem_oen_reg[0]_i_6\ : label is "soft_lutpair73";
...
\mem_oen_reg[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\mem_oen_reg[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity user_35t_axi_emc_0_0 is
  ...
  attribute x_core_info of user_35t_axi_emc_0_0 : entity is "axi_emc,Vivado 2020.1";
