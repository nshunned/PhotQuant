...
HD_PWD='C:/Users/photquant/VivadoProjects/Digilent_Cmod_A7_35T/uart/uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_byte.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky_byte.tcl -notrace
