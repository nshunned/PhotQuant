...
HD_PWD='C:/Users/photquant/VivadoProjects/Digilent_Cmod_A7_35T/uart/uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_byte.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_byte.tcl
