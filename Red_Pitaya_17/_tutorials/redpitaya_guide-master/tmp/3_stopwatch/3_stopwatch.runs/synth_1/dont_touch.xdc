...
# IP: bd/system/ip/system_xls_LEDs_0/system_xls_LEDs_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_xls_LEDs_0 || ORIG_REF_NAME==system_xls_LEDs_0} -quiet] -quiet

# IP: bd/system/ip/system_xls_CE_0/system_xls_CE_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_xls_CE_0 || ORIG_REF_NAME==system_xls_CE_0} -quiet] -quiet

# IP: bd/system/ip/system_xls_SCLR_0/system_xls_SCLR_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_xls_SCLR_0 || ORIG_REF_NAME==system_xls_SCLR_0} -quiet] -quiet
