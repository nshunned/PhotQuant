...
--               /media/sf_XilinxUbuntuVMShare/RP_SeqPID/rp_seqpid_src/seqpid/fpga_project/redpitaya.srcs/sources_1/ip/red_pitaya_pll_mod/red_pitaya_pll_mod_sim_netlist.vhdl
...
entity red_pitaya_pll_mod_red_pitaya_pll_mod_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of red_pitaya_pll_mod_red_pitaya_pll_mod_clk_wiz : entity is "red_pitaya_pll_mod_clk_wiz";
end red_pitaya_pll_mod_red_pitaya_pll_mod_clk_wiz;

architecture STRUCTURE of red_pitaya_pll_mod_red_pitaya_pll_mod_clk_wiz is
...
entity red_pitaya_pll_mod is
  ...
  attribute NotValidForBitStream of red_pitaya_pll_mod : entity is true;
end red_pitaya_pll_mod;

architecture STRUCTURE of red_pitaya_pll_mod is
begin
inst: entity work.red_pitaya_pll_mod_red_pitaya_pll_mod_clk_wiz
     port map (
      clk_adc => clk_adc,
