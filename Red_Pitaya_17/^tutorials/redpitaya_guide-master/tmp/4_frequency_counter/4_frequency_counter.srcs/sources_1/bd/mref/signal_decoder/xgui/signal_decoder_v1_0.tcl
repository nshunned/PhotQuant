...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BIT_OFFSET" -parent ${Page_0}
...
proc update_PARAM_VALUE.BIT_OFFSET { PARAM_VALUE.BIT_OFFSET } {
	# Procedure called to update BIT_OFFSET when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BIT_OFFSET { PARAM_VALUE.BIT_OFFSET } {
	# Procedure called to validate BIT_OFFSET
	return true
}
...
proc update_MODELPARAM_VALUE.BIT_OFFSET { MODELPARAM_VALUE.BIT_OFFSET PARAM_VALUE.BIT_OFFSET } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BIT_OFFSET}] ${MODELPARAM_VALUE.BIT_OFFSET}
}
