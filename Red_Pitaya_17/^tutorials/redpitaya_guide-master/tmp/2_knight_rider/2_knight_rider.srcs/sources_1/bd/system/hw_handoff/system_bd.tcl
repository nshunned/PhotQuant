...
proc create_root_design { parentCell } {
  ...
  # Create instance: knight_rider_0, and set properties
  set block_name knight_rider
  set block_cell_name knight_rider_0
  if { [catch {set knight_rider_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $knight_rider_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.DIR_INIT {0} \
   CONFIG.LEDS_INIT {"0000000011"} \
 ] $knight_rider_0

  # Create instance: knight_rider_1, and set properties
  set block_name knight_rider
  set block_cell_name knight_rider_1
  if { [catch {set knight_rider_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $knight_rider_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.DIR_INIT {1} \
   CONFIG.LEDS_INIT {"1100000000"} \
 ] $knight_rider_1
  ...
  connect_bd_net -net knight_rider_0_led_out [get_bd_pins knight_rider_0/led_out] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net knight_rider_1_led_out [get_bd_pins knight_rider_1/led_out] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports led_o] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins knight_rider_0/clk] [get_bd_pins knight_rider_1/clk] [get_bd_pins xlslice_0/Dout]
