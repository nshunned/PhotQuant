...
# IP: ip/internal_clks_pll/internal_clks_pll.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==internal_clks_pll || ORIG_REF_NAME==internal_clks_pll} -quiet] -quiet

# XDC: bd/system/system_ooc.xdc

# XDC: ip/internal_clks_pll/internal_clks_pll_board.xdc
set_property DONT_TOUCH TRUE [get_cells [split [join [get_cells -hier -filter {REF_NAME==internal_clks_pll || ORIG_REF_NAME==internal_clks_pll} -quiet] {/inst } ]/inst ] -quiet] -quiet

# XDC: ip/internal_clks_pll/internal_clks_pll.xdc
#dup# set_property DONT_TOUCH TRUE [get_cells [split [join [get_cells -hier -filter {REF_NAME==internal_clks_pll || ORIG_REF_NAME==internal_clks_pll} -quiet] {/inst } ]/inst ] -quiet] -quiet

# XDC: ip/internal_clks_pll/internal_clks_pll_ooc.xdc
