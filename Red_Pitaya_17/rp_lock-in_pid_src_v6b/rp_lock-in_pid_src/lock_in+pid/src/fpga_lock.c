...
{
    if (g_lock_reg) {
        g_lock_reg->oscA_sw				=      0;
        g_lock_reg->oscB_sw				=      0;
        g_lock_reg->osc_ctrl			=      3;
        g_lock_reg->trig_sw				=      0;
        g_lock_reg->mod_period			=      0;
        g_lock_reg->loc_osc_phase		=      0;
        g_lock_reg->demod_lpf			=      24;
        g_lock_reg->demod_gain			=      5;
        g_lock_reg->ramp_B_factor		=      0;
        g_lock_reg->ramp_freqexp		=      8;
        g_lock_reg->ramp_on				=      0;
        g_lock_reg->error_offset		=      0;
        g_lock_reg->offset_out_B		=      0;
        g_lock_reg->pid_kp				=      0;
        g_lock_reg->pid_PSR				=      2;
        g_lock_reg->pid_off				=      0;
        g_lock_reg->error_sw			=      0;
        g_lock_reg->pid_ki				=      0;
        g_lock_reg->pid_ISR				=      5;
        g_lock_reg->pid_i_on			=      0;
        g_lock_reg->pid_freeze			=      0;
        g_lock_reg->pid_kl				=      0;
        g_lock_reg->pid_LSR				=      5;
        g_lock_reg->pid_cl				=      4;
        g_lock_reg->pid_kf				=      0;
        g_lock_reg->pid_FSR				=      3;
        g_lock_reg->pid_cf				=      3;
        g_lock_reg->pid_kd				=      0;
        g_lock_reg->pid_DSR				=      3;
        g_lock_reg->pid_cd				=      2;
        g_lock_reg->rl_config			=      0;
        g_lock_reg->rl_unlocked			=      0;
        g_lock_reg->rl_error_max		=      0;
        g_lock_reg->rl_signal_min		=      0;
        g_lock_reg->rl_signal_max		=      0;
        g_lock_reg->error_mean			=      0;
        g_lock_reg->error_var			=      0;
        g_lock_reg->ramp_offset			=      0;
        g_lock_reg->ramp_ampl			=      0;
        g_lock_reg->ramp_offs_step		=      0;
        g_lock_reg->ramp_ampl_step		=      0;
    }
}
// [FPGARESET DOCK END]
