...
#define OSC_FPGA_BASE_SIZE 0x90000      // Ning: extended from 0x30000 to 0x90000
/** Size of data buffer into which input signal is captured , must be 2^n!. */
#define OSC_FPGA_SIG_LEN   (16*1024*8)  // Ning: extended from (16*1024) to (16*1024*8)
...
#define OSC_FPGA_CHB_OFFSET    0x10000  // Ning: updated from 0x20000 to 0x10000
